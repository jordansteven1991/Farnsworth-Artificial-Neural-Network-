...
public class Trainer
{
    public static void main(String[] args)throws IOException
    {
        ...
        Team buffalo = new Team(75.0,72.2,109.8,98.5,43.5,.7759,54,.011,34,"Buffalo","Mid American","Mid West");
        Team maryland = new Team(69.5,75.7,108.5,94.6,43.8,.8289,33,.131,37.2,"Maryland","ACC","East");
        Team valp = new Team(69.8,68.3,103.8,94.3,45.9,.7499,63,.070,37.8,"Valparaiso","Horizon Leaugue","Mid West");
        ...
        Team notreDame = new Team(78.8,74.0,122.2,99.7,51.0,.9127,10,.064,39.2,"Notre Dame","ACC","Mid West");
        Team northEast = new Team(68.6,72.5,106.0,102.4,48.6,.5980,120,.037,38.8,"North Eastern","Colonial","Mid West");
        Team wichitaSt = new Team(69.7,68.8,113.0,92.9,44.6,.9044,14,.018,36.2,"Wichita State","Missouri Valley","Mid west");
        Team indiana = new Team(77.5,71.5,116.6,104.7,46.6,.7762,53,-.032,40.3,"Indiana","Big Ten","Mid West");
        Team kansas = new Team(71.2,72,110.8,90.5,44,.9111,11,.079,37.5,"Kansas","Big 12","Mid West");
        Team newMexSt = new Team(68.5,69.4,104.1,97.9,46.6,.6674,88,-.051,36.8,"New Mexico State","West Athletic","Mid West");
        ...
        Team ccar = new Team(71.7,68.8,103.5,102.2,43.9,.5371,148,.006,35.6,"Coastal Carolina","Big South","West");
        ...
        Team northCarolina = new Team(77.9,70.0,115.3,95.0,47.5,.9019,16,-.034,34.5,"North Carolina","ACC","West");
        ...
        Team ohioState = new Team(75.8,67.8,111.6,94.7,48.6,.8680,21,-.051,37.2,"Ohio State","Big Ten","West");
        ...
        Team sanDSt = new Team(61.8,62.9,102.4,88.3,41.9,.8468,27,.014,32.0,"San Diego St","Mountain West","South");
        Team utah = new Team(72.1,69.9,113.0,90.6,48.5,.9275,8,-.056,40.4,"Utah","Pac 12","South");
        Team stephenA = new Team(79.5,73.4,113.0,99.1,49.1,.8183,35,.030,38.6,"Stephen F. Austin","???","South");
        Team gtown = new Team(70.7,70.2,110.3,93.7,45.5,.8670,22,-.002,34.7,"Georgetown","Big East","South");
        Team eastWash = new Team(80.8,72.3,110.0,107.7,48.0,.5168,136,.074,40.3,"Eastern Washington","???","South");
        ...
        Team iowaState = new Team(78.4,69.6,118.9,97.7,48.0,.9047,13,.023,36.6,"Iowa State","Big Ten","South");
