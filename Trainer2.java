...
public class Trainer2
{
    ...
    //    Team northCarolina = new Team(79.4,72.3,115.3,93.2,46.4,.9206,10,.01,"North Carolina","ACC","East");
     Team northCarolina = new Team(78.3,68.8,114.2,95.6,47.1,.8857,16,-.038,32.8,"North Carolina","ACC","East");    
        Team ohioState = new Team(80.0,70.0,113.8,95.8,50.9,.8791,22,-.49,.5322,"Ohio State","Big Ten","East");
        ...
        Team southCarolina = new Team(67.7,72.7,101.0,89.5,41.7,.8004,44,-.125,29.8,"South Carolina","SEC", "Southern");
        ...
        Team georgeWash = new Team(67.7,67.9,103.6,94.4,44.6,.7442,71,.077,32.3,"George Washington","Atlantic 10","East");
        
        Team okSt = new Team(68.0,71.7,108.3,90.6,43.6,.8855,18,.013,33.3,"Oklahoma State","Big 12","Mid West");
        Team tcu = new Team(69.2,59.7,102.4,92.3,43.9,.7678,61,-.080,33.6,"TCU","Big 12","Mid West");
        
        Team villanova = new Team(74.8,70.6,115.9,90.3,46.4,.9463,7,.028,36.8,"Villanova","Big East","Mid West");
        ...
        Team iowaState = new Team(80.0,68.8,118.0,99.2,48.8,.8810,20,-.007,35.8,"Iowa State","Big Ten","East");
